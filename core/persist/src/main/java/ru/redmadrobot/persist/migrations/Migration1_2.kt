...
import ru.redmadrobot.persist.migrations.Migrations.VERSION_3
...
object Migration2_3 : Migration(VERSION_2, VERSION_3) {
    ...
    override fun migrate(database: SupportSQLiteDatabase) {
        ...
        database.execSQL(
            """INSERT INTO ${FavoriteMovieDb.TABLE_NAME}_3 (
                ...
                vote_average,
                runtime,
                is_watched FROM ${FavoriteMovieDb.TABLE_NAME}""".trimIndent()
        )
